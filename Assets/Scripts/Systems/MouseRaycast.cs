...
public class MouseRaycast : MonoBehaviour
{
    ...
    /// <summary>
    /// Convertit la position �cran de la souris en position monde et direction du rayon
    /// </summary>
    ...
    /// <summary>
    /// Raymarching le long du rayon pour d�tecter l'intersection avec le terrain
    /// </summary>
    private Vector3 RaymarchToTerrain(Vector3 startPos, Vector3 rayDirection)
    {
        ...
        for (int i = 0; i < steps; i++)
        {
            ...
            {
                return p; // Intersection trouv�e
            }

            p = newP;
        }

        return lowerBound; // Pas d'intersection trouv�e
    }
}
